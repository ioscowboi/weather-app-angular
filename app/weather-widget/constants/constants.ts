export const FORECAST_KEY = "69f782e21de3b9af638834b944133e28";

export const FORECAST_ROOT = "https://api.darksky.net/forecast/"; 

// google geocoding api key: 
export const GOOGLE_KEY = "AIzaSyBoWmtpoid-s2ozQgI7OFGC0UOAt7tj-Uo";

export const GOOGLE_ROOT = "https://maps.googleapis.com/maps/api/geocode/json";

export const WEATHER_COLORS = {
    // load these colors until API data comes through:
    'default':{
